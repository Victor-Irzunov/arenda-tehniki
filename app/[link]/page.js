...
export function generateMetadata({ params: { link } }) {
	...
	switch (link) {
		...
		case 'arenda-frontalnyh-pogruzchikov':
			title = 'Аренда фронтального погрузчика в Минске | Доставка по Беларуси';
			description = 'Арендуйте фронтальные погрузчики грузоподъемностью 1-10 тонн в Минске с доставкой на объект по всей Беларуси. Большой выбор техники. Опытные операторы. Гибкие условия аренды, выгодные цены. Звоните!';
			break;
		...
		case 'arenda-exkavatora-pogruzchika':
			title = 'Аренда экскаватора-погрузчика в Минске | Доставка по Беларуси';
			description = 'Предлагаем в аренду экскаваторы-погрузчики (ЭП) грузоподъемностью 1-5 тонн в Минске с доставкой на объект по всей Беларуси. Большой выбор техники от ведущих производителей. Опытные операторы, гибкие условия аренды, приемлемые цены. Звоните!';
			break;
