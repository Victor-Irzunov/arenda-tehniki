...
export const metadata = {
	title: 'Контакты компании ООО ГрузБел | Аренда спецтехники',
	description: 'Страница с контактной информацией компании ООО ГрузБел, предоставляющей услуги по аренде спецтехники. Указаны адрес, телефоны, email, график работы.',
	keywords: 'аренда спецтехники, ГрузБел, контакты, адрес, телефон, email',
	openGraph: {
		title: 'Контакты ООО ГрузБел | Аренда спецтехники в Москве',
		description: 'Страница с контактной информацией компании ООО ГрузБел, предоставляющей услуги по аренде спецтехники в Москве и МО. Указаны адрес, телефоны, email, график работы.',
		type: 'website',
		url: 'https://ГрузБел.рф/контакты',
		locale: 'ru_RU'
	}
};
